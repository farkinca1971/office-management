...
export const de = {
  ...
  relations: {
    title: 'Beziehungen',
    loadFailed: 'Fehler beim Laden der Beziehungen',
    noRelations: 'Keine Beziehungen gefunden',
    addNew: 'Neue Beziehung hinzufügen',
    createRelation: 'Beziehung erstellen',
    direction: 'Richtung',
    relationType: 'Beziehungstyp',
    relatedObject: 'Verknüpftes Objekt',
    note: 'Notiz',
    loading: 'Beziehungen werden geladen...',
    showing: 'Zeige',
    of: 'von',
    allTypes: 'Alle Typen',
    filterRelatedObject: 'Nach verknüpftem Objekt filtern...',
    unknown: 'Unbekannt',
    outgoing: 'Ausgehend',
    incoming: 'Eingehend',
    deleteConfirm: 'Möchten Sie diese Beziehung wirklich löschen?',
    deleted: 'Beziehung erfolgreich gelöscht',
    updated: 'Beziehung erfolgreich aktualisiert',
    created: 'Beziehung erfolgreich erstellt',
    // Advanced search
    ...
    selectRelationType: 'Beziehungstyp auswählen',
    noteOptional: 'Notiz (optional)',
    notePlaceholder: 'Notiz zur Beziehung hinzufügen...',
    creating: 'Wird erstellt...',
    noObjectsFound: 'Keine Objekte gefunden',
    selectObject: 'Wählen Sie ein Objekt aus, um eine Beziehung zu erstellen',
  },
};
