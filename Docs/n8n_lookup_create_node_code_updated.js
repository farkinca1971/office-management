 ...
 * - parent_object_type_id: For object-relation-types - the parent object type ID
 * - child_object_type_id: For object-relation-types - the child object type ID
 * - mirrored_type_id: For object-relation-types - the mirrored relation type ID (can be null)
 * 
 * Behavior:
